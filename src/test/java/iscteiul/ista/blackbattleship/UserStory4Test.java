...
public class UserStory4Test {
     ...
     * {@code /en/friends}.
     *
     * <p>Reproduz os passos 3 a 7 do Selenium IDE.</p>
     *
     * <p><strong>Asserção:</strong> o URL deve conter {@code /en/friends}
     * após o clique na hiperligação "Friends".</p>
     */
    @Test
    public void loginAndNavigateToFriends() throws InterruptedException {
        // Passo 3 – click css=.btn-outline-dark
        userStory4Page.loginButton.click();
        sleep(5000);

        // Passo 4 – type id=mat-input-serverApp0
        userStory4Page.emailInput.sendKeys("goufrappocrugra-7205@y.w80.it");
        sleep(1000);

        // Passo 5 – type id=mat-input-serverApp1
        userStory4Page.passwordInput.sendKeys("12345678");
        sleep(1000);

        // Passo 6 – click botão Login do diálogo
        userStory4Page.loginDialogButton.click();
        sleep(5000);

        // Passo 7 – click linkText=Friends
